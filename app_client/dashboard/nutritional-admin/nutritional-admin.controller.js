...
.controller('dashboardNutritionalAdminCtrl', dashboardNutritionalAdminCtrl);

function dashboardNutritionalAdminCtrl(stationsSvc, authSvc, nutritionalDataSvc, $scope){
  var vm = this;
  vm.stations = [];
  vm.sectors  = [];
  vm.nutritionalData = [];
  ...
  vm.loadData = () => {
    nutritionalDataSvc.getAllDataList(vm.currentPage-1, vm.pageSize)
    .error((err) => {
      vm.errMessage = err.message;
      console.log(err);
    })
