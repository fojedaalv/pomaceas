  ...
  vm.getDataInArray = function(){
    ...
    for(var i=0;i<vm.data.dataset0.length;i++){
      ...
      data.push({
        ...
        tempMediaMaxi: row.tempMediaMax.toLocaleString('es-CL'),
        tempMediaMin: row.tempMediaMin.toLocaleString('es-CL'),
        tempMaxMax: row.tempMaxMax.toLocaleString('es-CL'),
        tempMinMin: row.tempMinMin.toLocaleString('es-CL'),
        hrMedia: row.hrMedia.toLocaleString('es-CL'),
        hrMaxima: row.hrMaxima.toLocaleString('es-CL'),
        hrMinima: row.hrMinima.toLocaleString('es-CL'),
        horas95: row.horas95.toLocaleString('es-CL'),
        estres: row.estres.toLocaleString('es-CL'),
        gdMaxYMin: row.gdMaxYMin.toLocaleString('es-CL'),
        gdh: row.gdh.toLocaleString('es-CL'),
        gd: row.gd.toLocaleString('es-CL'),
        mineq10: row.mineq10.toLocaleString('es-CL'),
        min105hrs: row.min105hrs.toLocaleString('es-CL'),
        mineq7: row.mineq7.toLocaleString('es-CL'),
        richardson: row.richardson.toLocaleString('es-CL'),
        unrath: row.unrath.toLocaleString('es-CL'),
        diasHel: row.diasHel.toLocaleString('es-CL'),
        hrmen0c: row.hrmen0c.toLocaleString('es-CL'),
        hrmay27c: row.hrmay27c.toLocaleString('es-CL'),
        hrmay29c: row.hrmay29c.toLocaleString('es-CL'),
        hrmay32c: row.hrmay32c.toLocaleString('es-CL'),
        dias5hrsmay27: row.dias5hrsmay27.toLocaleString('es-CL'),
        dias5hrsmay29: row.dias5hrsmay29.toLocaleString('es-CL'),
        dias5hrsmay32: row.dias5hrsmay32.toLocaleString('es-CL'),
        hrmen6c: row.hrmen6c.toLocaleString('es-CL'),
        hrmen12c: row.hrmen12c.toLocaleString('es-CL'),
        hrmen18c: row.hrmen18c.toLocaleString('es-CL'),
        hrmay15c: row.hrmay15c.toLocaleString('es-CL'),
        et0: row.et0.toLocaleString('es-CL'),
        horasRad12: row.horasRad12.toLocaleString('es-CL'),
        horasRad300: row.horasRad300.toLocaleString('es-CL'),
        maxRad: row.maxRad.toLocaleString('es-CL'),
        energia: row.energia.toLocaleString('es-CL'),
        vmaxViento: row.vmaxViento.toLocaleString('es-CL'),
        hrAbe: row.hrAbe.toLocaleString('es-CL'),
        pp: row.pp.toLocaleString('es-CL'),
        hrTOpt: row.hrTOpt.toLocaleString('es-CL'),
        dpv: row.dpv.toLocaleString('es-CL'),
        hrsDPVmay2p5: row.hrsDPVmay2p5.toLocaleString('es-CL')
      })
    }
    return data;
  }
